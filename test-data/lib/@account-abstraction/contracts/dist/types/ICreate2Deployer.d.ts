...
export interface ICreate2Deployer extends BaseContract {
    ...
    functions: {
        deploy(initCode: PromiseOrValue<BytesLike>, salt: PromiseOrValue<BytesLike>, overrides?: Overrides & {
    ...
    callStatic: {
        deploy(initCode: PromiseOrValue<BytesLike>, salt: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<string>;
    };
    filters: {};
    estimateGas: {
        deploy(initCode: PromiseOrValue<BytesLike>, salt: PromiseOrValue<BytesLike>, overrides?: Overrides & {
